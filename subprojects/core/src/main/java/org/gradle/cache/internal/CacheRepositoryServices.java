...
public class CacheRepositoryServices {
    ...
    protected CacheKeyBuilder createCacheKeyBuilder(FileHasher fileHasher, ClasspathHasher snapshotter, ClassLoaderHierarchyHasher classLoaderHierarchyHasher) {
