        ...
        buildFile << """
            allprojects {
                configurationAttributesSchema {
                   attribute(Attribute.of('view', String))
                }
            }
            project(':libInclude') {
                apply plugin: 'java'
    ...
    def "can filter artifacts based on component id"() {
        ...
        buildFile << """
            ...
            class ViewFilter extends org.gradle.api.artifacts.transform.ArtifactFilter {
                ...
                boolean include(ComponentIdentifier component) {
...
"""
    ...
    def "does not build project components excluded from view"() {
        ...
        buildFile << """
            ...
            def filteredView = configurations.compile.incoming.getFiles(view: 'filtered')
            def unfilteredView = configurations.compile.incoming.getFiles(view: 'unfiltered')
